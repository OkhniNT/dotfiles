...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey }, "comma", function () awful.tag.incncol( 1, nil, true) end, {description = "increase the number of columns", group = "layout"}),
    awful.key({ modkey }, "period", function () awful.tag.incncol(-1, nil, true) end, {description = "decrease the number of columns", group = "layout"}),
    ...
    -- Change layout
    awful.key({ modkey, "Shift" }, "-", function () awful.spawn("layout-select") end, {}),
